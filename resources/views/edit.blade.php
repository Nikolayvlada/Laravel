...
<script>
  function senderAddressBook() {
    var base_url = "{{url('/')}}";
    location.href = base_url + "/shipment/saddress_e";
  }

  function receiverAddressBook() {
    var base_url = "{{url('/')}}";
    location.href = base_url + "/shipment/raddress_e";
  }
</script>
<style>
  .ni-trash-fill {
              ...
              <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                  <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Edit Shipment {{$shipment->hwb}}</h3>
                  </div>
                          ...
                          <div class="col-lg-5">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="scompany_name" placeholder="Company" value="{{$shipment->sender_company}}">
                              </div>
                            </div>
                          </div>
						<div class="col-lg-2">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="scountry_code" placeholder="VAT/Tax ID" value="{{$shipment->sender_countrycode}}">
                              </div>
                            </div>
                          </div>	
                          <div class="col-lg-5">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sfull_name" placeholder="Full name" value="{{$shipment->sender_fullname}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="saddress1" placeholder="Address 1" value="{{$shipment->sender_address1}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="saddress2" placeholder="Address 2" value="{{$shipment->sender_address2}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="szipcode" placeholder="Zipcode" value="{{$shipment->sender_zipcode}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="scity" placeholder="City" value="{{$shipment->sender_city}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sstate" placeholder="State" value="{{$shipment->sender_state}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sphone_number" placeholder="Phone number" value="{{$shipment->sender_phone}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="semail" placeholder="Email" value="{{$shipment->sender_email}}">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <form action="#" _lpchecked="1">
                        <div class="row g-4">
                          <div class="col-lg-5">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rcompany_name" placeholder="Company" value="{{$shipment->receiver_company}}">
                              </div>
                            </div>
                          </div>
						<div class="col-lg-2">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rcountry_code" placeholder="VAT/ TAX ID" value="{{$shipment->receiver_countrycode}}">
                              </div>
                            </div>
                          </div>	
                          <div class="col-lg-5">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rfull_name" placeholder="Full name" value="{{$shipment->receiver_fullname}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="raddress1" placeholder="Address 1" value="{{$shipment->receiver_address1}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="raddress2" placeholder="Address 2" value="{{$shipment->receiver_address2}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rzipcode" placeholder="Zipcode" value="{{$shipment->receiver_zipcode}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rcity" placeholder="City" value="{{$shipment->receiver_city}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-4">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rstate" placeholder="State" value="{{$shipment->receiver_state}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="rphone_number" placeholder="Phone number" value="{{$shipment->receiver_phone}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="remail" placeholder="Email" value="{{$shipment->receiver_email}}">
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="form-control-wrap ">
                              <div class="form-control-select">
                                <select class="form-control" id="shipment_type">
                                  ...
                                  <option value="DOC"<?php if($shipment->shipment_type == "DOC") echo 'selected'; ?>>DOC</option>
                                  <option value="WPX" <?php if($shipment->shipment_type == "WPX") echo 'selected'; ?>>WPX</option>
                                </select>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-control-wrap ">
                              <div class="form-control-select">
                                <select class="form-control" id="shipment_service">
                                  ...
                                  <option value="DHL SG" <?php if($shipment->shipment_service == "DHL SG") echo 'selected'; ?>>DHL SG</option>
                                  <option value="UPS SG" <?php if($shipment->shipment_service == "UPS SG") echo 'selected'; ?>>UPS SG</option>
                                  <option value="CT KOREA" <?php if($shipment->shipment_service == "CT KOREA") echo 'selected'; ?>>CT KOREA</option>
                                </select>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-control-wrap ">
                              <div class="form-control-select">
                                <select class="form-control" id="shipment_reason">
                                  ...
                                  <option value="Gift" <?php if($shipment->shipment_reason == "Gift") echo 'selected'; ?>>Gift</option>
                                  <option value="Sample" <?php if($shipment->shipment_reason == "Sample") echo 'selected'; ?>>Sample</option>
                                  <option value="Other" <?php if($shipment->shipment_reason == "Other") echo 'selected'; ?>>Other</option>
                                </select>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="form-control-select">
                                <select class="form-control" id="uid">
                                  ...
                                  @foreach ($user_group as $user)
                                    <option value="{{$user->id}}" <?php if ($user->id == $shipment->uid) echo 'selected'; ?>>{{$user->name}}</option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
                          ...
                          <table class="table" id="tableitem">
                            ...
                            <tbody >
                              @if (count($product_info))
                                @foreach ($product_info as $elem)
                                  <tr>
                                    <td><input type="text" class="form-control item-name"  placeholder="item name" value="{{$elem->item_name}}"></td>
                                    <td><input type="text" class="form-control item-hscode"  placeholder="HS CODE" value="{{$elem->hs_code}}"></td>
                                    <td><input type="number" class="form-control item-quantily"  placeholder="quantily" value="{{$elem->qty}}"></td>
                                    <td><select class="form-control item-type">
                                        <option value="PCS" <?php if ($elem->type == "PCS") echo "selected"; ?>>PCS</option>
                                        <option value="BOX" <?php if ($elem->type == "BOX") echo "selected"; ?>>BOX</option>
                                      </select></td>
                                    <td><input type="number" class="form-control item-price" value="{{$elem->unit_price}}"></td>
                                    <td><input type="text" class="form-control item-subtotal" value="{{$elem->subtotal}}" readonly></td>
                      ...
                      <div class="row g-4">
                        <div class="col-lg-12">
                          <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-end">
                              <div class="form-control-wrap">
                                ...
                                <span id="totalpkg" class="form-control">{{$shipment->total_pkg}}</span></div>
                              </div>
							                <div>&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                ...
                                <div class="input-group-prepend"> <span class="input-group-text" id="inputGroup-sizing-sm">Total weight</span> </div>
									              <span id="totalweight" class="form-control">{{$shipment->total_weight}}</span></div>
                              </div>	
                              <div>&nbsp;&nbsp;&nbsp;&nbsp;</div>
                              <div class="form-control-wrap">
                                <div class="input-group input-group-sm">
                                <div class="input-group-prepend"> <span class="input-group-text" id="inputGroup-sizing-sm">Total charge</span> </div>
                                <span id="totalcharge" class="form-control">{{$shipment->total_charge}}</span></div>
                              </div>
                            </div>
                          </div>
                          <table class="table" id="tablepkg">
                            ...
                            <tbody>
                              @foreach($package_info as $elem)
                              <tr>
                                <td><select class="form-control qtypkg" id="qtypkg">
                                    <option value="0" <?php if($elem->qty_pkg == '0') echo 'selected'; ?>>0</option>
                                    <option value="1" <?php if($elem->qty_pkg == '1') echo 'selected'; ?>>1</option>
                                    <option value="2" <?php if($elem->qty_pkg == '2') echo 'selected'; ?>>2</option>
                                    <option value="3" <?php if($elem->qty_pkg == "3") echo 'selected'; ?>>3</option>
                                    <option value="4" <?php if($elem->qty_pkg == "4") echo 'selected'; ?>>4</option>
                                    <option value="5" <?php if($elem->qty_pkg == "5") echo 'selected'; ?>>5</option>
                                    <option value="6" <?php if($elem->qty_pkg == "6") echo 'selected'; ?>>6</option>
                                    <option value="7" <?php if($elem->qty_pkg == "7") echo 'selected'; ?>>7</option>
                                    <option value="8" <?php if($elem->qty_pkg == "8") echo 'selected'; ?>>8</option>
                                    <option value="9" <?php if($elem->qty_pkg == "9") echo 'selected'; ?>>9</option>
                                    <option value="10" <?php if($elem->qty_pkg == "10") echo 'selected'; ?>>10</option>
                                  </select></td>
                                <td>
                                  <select class="form-control pkg-type" id="item-type">
                                    <option value="BOX" <?php if($elem->type_pkg == 'BOX') echo 'selected'; ?>>BOX</option>
                                    <option value="BAG" <?php if($elem->type_pkg == 'BAG') echo 'selected'; ?>>BAG</option>
                                    <option value="PALLET" <?php if($elem->type_pkg == 'PALLET') echo 'selected'; ?>>PALLET</option>
                                  </select>
                                </td>
                                <td><input type="number" class="form-control pkglength" id="pkglength" value="{{$elem->lenght_pkg}}" placeholder="length (cm)"></td>
                                <td><input type="number" class="form-control pkgwidth" id="pkgwidth" value="{{$elem->width_pkg}}" placeholder="width (cm)"></td>
                                <td><input type="number" class="form-control pkgheight" id="pkgheight" value="{{$elem->height_pkg}}" placeholder="height (cm)"></td>
                                <td><input type="number" class="form-control pkgweight" id="pkgweight" value="{{$elem->weight_pkg}}" placeholder="weight (kg)"></td>
                                <td><span id="subweight" class="form-control subweight">{{$elem->total_weight}}</span></td>
								                <td><span id="subvolume" class="form-control subvolume">{{$elem->volume_pkg}}</span></td>  
                                <td><span id="subcharge" class="form-control subcharge">{{$elem->charge_pkg}}</span></td>
                                <td><button type="button" class="btn btn-primary addpkgbtn" onclick="displaypkg()">+ Add</button>&nbsp;&nbsp;&nbsp;&nbsp;<button id="removePackInfo" type="button" class="btn btn-danger pkgGroupBtn">- Remove</button></td>
                              </tr>
                              @endforeach
                            </tbody>
                          </table>
...
<script>
  ...
  $().ready(function() {
    val1= "{{$shipment->sender_country}}";
    val2 = "{{$shipment->receiver_country}}"
    $('#scountry_name').val(val1);
    $('#scountry_name').trigger("change");
    
    $('#rcountry_name').val(val2);
    $('#rcountry_name').trigger("change");

  });
  var origin_uid = "{{$shipment->uid}}";
